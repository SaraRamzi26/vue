...
var Y = "Vellum";
var q = "Whiteboard";
var xl = [u, l, h2, t, g, n, m, p, s, y, w, x, e, b, c, o, I, a, r, v, i, F, d, S];
var cl = (_cl = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_cl, u, A), l, P), h2, j), t, B), g, N), n, D), m, k), p, T), s, C), y, W), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_cl, w, R), x, K), e, L), b, U), c, J), o, _), I, M), a, E), r, G), v, V), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_cl, i, z), F, O), d, Y), S, q));
var Al = {
  classic: {
    900: "fas",
    400: "far",
...
function classList(props) {
  ...
  }, _defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_classes, "fa-".concat(props.size), props.size !== null), "fa-rotate-".concat(props.rotation), props.rotation !== null), "fa-rotate-by", props.rotateBy), "fa-pull-".concat(props.pull), props.pull !== null), "fa-swap-opacity", props.swapOpacity), "fa-bounce", props.bounce), "fa-shake", props.shake), "fa-beat", props.beat), "fa-fade", props.fade), "fa-beat-fade", props.beatFade), _defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_classes, "fa-flash", props.flash), "fa-spin-pulse", props.spinPulse), "fa-spin-reverse", props.spinReverse), "fa-width-auto", props.widthAuto), "fa-canvas-square", props.canvasSquare), "fa-canvas-roomy", props.canvasRoomy), "fa-flip-360", props.flip360), "fa-buzz", props.buzz), "fa-float", props.float), "fa-jello", props.jello), _defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2(_classes, "fa-spin-snap", props.spinSnap), "fa-spin-snap-4", props.spinSnap4), "fa-spin-snap-8", props.spinSnap8), "fa-swing", props.swing), "fa-wag", props.wag));
...
function stripFillsFromPaths(abstractElement) {
  ...
  if (abstractElement.tag === "path" && abstractElement.attributes && "fill" in abstractElement.attributes) {
    return _objectSpread22(_objectSpread22({}, abstractElement), {}, {
      attributes: _objectSpread22(_objectSpread22({}, abstractElement.attributes), {}, {
        fill: void 0
      }),
      children
    });
...
function convert(abstractElement) {
  ...
  if (gradientFill && gradientFill.id && (gradientFill.type === "linear" || gradientFill.type === "radial")) {
    ...
    var gradientVNode = h(gradientTag, _objectSpread22(_objectSpread22({}, gradientProps), {}, {
      id
    }), stops.map(createGradientStop));
    return h(element.tag, _objectSpread22(_objectSpread22(_objectSpread22(_objectSpread22({}, renderProps), {}, {
      class: mixins.class,
      style: _objectSpread22(_objectSpread22({}, mixins.style), aStyle)
    }, mixins.attrs), otherAttrs), {}, {
      fill: "url(#".concat(id, ")")
    }), [gradientVNode].concat(_toConsumableArray2(children)));
  }
  return h(abstractElement.tag, _objectSpread22(_objectSpread22(_objectSpread22({}, renderProps), {}, {
    class: mixins.class,
    style: _objectSpread22(_objectSpread22({}, mixins.style), aStyle)
